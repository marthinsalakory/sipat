                    ...
                    <form action="<?= BASEURL; ?>/login/login" method="POST" class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <!-- DEBUG-VIEW START 1 VENDORPATH/myth/auth/src/Views/_message_block.php -->



                                <!-- DEBUG-VIEW ENDED 1 VENDORPATH/myth/auth/src/Views/_message_block.php -->
                                <div class="form-group form-primary">
                                    <input type="text" name="username" class="form-control " required="" placeholder="Username / Email" value="">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="login" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Login</button>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><a href="register.php"><b class="f-w-600">Daftar sekarang</b></a></p>
                                    </div>
                                    <div class="col-md-2">
                                        <img src="<?= BASEURL; ?>\assets\files\assets\images\auth\Logo-small-bottom.png" alt="small-logo.png">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="<?= BASEURL; ?>\assets/files/assets/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="<?= BASEURL; ?>\assets/files/assets/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="<?= BASEURL; ?>\assets/files/assets/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="<?= BASEURL; ?>\assets/files/assets/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="<?= BASEURL; ?>\assets/files/assets/images/browser/ie.png" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
...
<![endif]-->
    ...
    <script type="text/javascript" src="<?= BASEURL; ?>\assets\files\assets\js\common-pages.js"></script>
