            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>Halaman data pemrosesan data pengajuan</h4>
        ...
        <div class="page-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>Tabel data pengajuan yang sedang diproses</h5>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($data['dalam_proses'] as $d) : ?>
                                    <tr>
                                        <td><?= ++$no; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-success btn-skew btn-sm">Dalam Proses</button>
                                        </td>
                                        <td><?= $d['sub_bagian']; ?></td>
                                        <td><?= $d['keperluan']; ?></td>
                                        <td><?= $d["waktu"]; ?></td>
